...
vim.keymap.set("v", "<leader>gb", ':GBrowse!<cr>',
  { desc = "copy link to file at visually selected line number", silent = true })
...
vim.keymap.set("n", "<C-z>", '<Nop>',
  { desc = "disable sending nvim to background so we can use tmux.nvim to fullsize panes with the key" })
